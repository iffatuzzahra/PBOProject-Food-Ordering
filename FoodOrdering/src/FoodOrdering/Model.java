...
public class Model {
    ...
    public void addFood(String foodName, int price, String categories) {
        try {
            String query = "INSERT INTO food (FoodName, Price, Categories) VALUE('"+foodName+"','"+price+"','"+categories+"') ";
    ...
    public void addToOrder(String namaPemesan) {
        try {
            ...
            String sql = "INSERT INTO `order` (`CustomerName`, `OrderAmount`, `Total`) VALUE ('"+namaPemesan+"','"+amount+"','"+bayar+"')";
            statement.executeUpdate(sql);
    ...
    public void updateMenu(int id, String name, int price, String cat) {
        try {
            String query = "UPDATE `food` SET `FoodName`='"+name+"', `Price`='"+price+"', `Categories`='"+cat+"' WHERE `FoodId`='"+id+"' ";
            statement = koneksi.createStatement();
            statement.executeUpdate(query);
